    ...
    <header class="absolute top-0 left-0 right-0 z-20">
        <nav class="container px-6 py-4 mx-auto md:px-12">
            <div class="items-center justify-between md:flex">
                ...
                <Link href="/"  class="px-3 py-2 text-gray-400 uppercase transition duration-200 ease-in hover:text-gray-700 focus:outline-none">
                        Login
                    </Link>
                    <Link href="/signup"   class="px-3 py-2 text-gray-400 uppercase transition duration-200 ease-in hover:text-gray-700 focus:outline-none">
                        Register
                    </Link>
                </div>
            </div>
    ...
    <div class="container z-10 flex items-center justify-between h-screen px-6 pt-32 mx-auto md:pt-0">
        <div class="container relative flex flex-col-reverse items-center justify-between px-6 mx-auto lg:flex-row">
            <div class="w-full mb-16 text-center md:mb-8 lg:text-left">
                ...
                <Link href="/" class="px-2 py-2 mt-16 text-lg font-light transition duration-200 ease-in bg-yellow-300 border-2 border-gray-700 w-36 hover:bg-yellow-400 focus:outline-none">
                    Go back home
                </Link>
            </div>
